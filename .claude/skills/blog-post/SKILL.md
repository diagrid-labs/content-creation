...
## Suggest to create the sections of the blog post

Ask the user if they want to generate commented out sections of the blog post based on the instructions in those comments. If the answer is yes, clear the context, load the generated markdown into the context and iterate over the sections and generate them, asking for verification between each section.