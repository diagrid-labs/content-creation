...
| Dev.to (title 120 / body 1200) | 120 / 1200 | None inline (Dev.to uses front-matter tags, out of scope here) | `@diagrid` (only when natural) | Minimal (0-1) | Blog-style post, technical, neutral | At the end of the post | `dev-to` |
| Medium (title 120 / body 1200) | 120 / 1200 | None inline (Medium uses its own tags, out of scope here) | None | Minimal (0-1) | Blog-style post, technical, neutral (same content as Dev.to) | At the end of the post | `medium` |
...
### Dev.to
- Blog-style: a title (max 120 chars) and a body (max 1200 chars) structured like a short blog post, not a share blurb.
...
- Body (max 1200 chars) is a short blog post: intro that leads with the technical takeaway, two to four sections with subheadings (`###` or `####`, never `##`), and a closing CTA.
- Link at the end of the body.
